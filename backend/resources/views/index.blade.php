...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{ asset('template/vendors/styles/core.css') }}">
    <link rel="stylesheet" href="{{ asset('template/vendors/styles/icon-font.min.css') }}">
