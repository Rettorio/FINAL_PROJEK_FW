        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    <h4 class="text-primary mb-4">Contact Desa </h4>
                    <h1 class="display-5 mb-4">Hubungin Kami Jika Ada Masala</h1>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <h2 class="display-5 mb-2">Lengkapi Formulir</h2>
                        <p class="mb-4">Formolir Ini Bertujuan Untuk Mnegetahui Siapa yang Mengirim Informasi Kepada Admin Desa <a class="text-primary fw-bold" href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
                        <form>
                            <div class="row g-3">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-4">
                                <h4>Balai Desa</h4>
                                <p class="mb-0">Balai Pertemuan Desa</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-4">
                                <h4>Email Desa</h4>
                                <p class="mb-0">desaku@gmial.com</p>
                                <p class="mb-0">infodesaku@example.com</p>
                            </div>
                        </div>
